        ...
        <div class="row">
            <div class="col-md-offset-2 col-md-8">
                <div class="reg_form_content_bg"> 
                    ...
                    <div class="row">
                        <div class="col-md-offset-3 col-md-7">
                            <span class="header_text_style2">(Contribution Your Talent for Social Networking)</span>
                        </div>
                    </div>
                    ...
                    <div class="row form-group">
                        <div class="col-md-offset-1 col-md-3">
                            <label class="reg_form_label_style">Religion:<span class="reg_required_style">*</span></label>
                        </div>
                        <div class="col-md-7">
                    ...
                    <div class="row">
                        <div class="col-md-offset-9 col-md-2">
                            <?php echo form_input($submit + array('class' => 'btn btn-primary sm pull-right')); ?>
                        </div>
                    </div>
                    <?php echo form_close(); ?>
                </div>
